...
def _result() -> dict:
    return {
        "extraction": {
            ...
            "fields": [
                {"name": "Invoice Number", "value": "INV-2026-001", "confidence": 0.95, "data_type": "identifier"},
                {"name": "Vendor", "value": "Acme GmbH", "confidence": 0.9, "data_type": "text"},
                {"name": "Total Amount", "value": "€12,500.00", "confidence": 0.92, "data_type": "currency"},
                {"name": "Subtotal", "value": "€10,000.00", "confidence": 0.9, "data_type": "currency"},
                {"name": "VAT ID", "value": "DE123456789", "confidence": 0.85, "data_type": "identifier"},
                {"name": "PO Number", "value": "PO-77", "confidence": 0.8, "data_type": "identifier"},
                {"name": "Invoice Date", "value": "2026-05-30", "confidence": 0.9, "data_type": "date"},
            ],
        }
    }
